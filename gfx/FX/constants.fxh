...
static const float COLORMAP_OVERLAY_STRENGTH 	= 1.05f; //0.6f;
...
static const float GB_THRESHOLD = 0.8f; // interpolation time
static const float GB_THRESHOLD2 = 0.5f; // interpolation time
//static const float3 GB_OUTLINE_COLOR = float3( 0.0f, 0.0f, 0.0f );
static const float GB_OUTLINE_CUTOFF_SEA = 0.985f; // Magic number to balance cutoff on edges without neighbor (over Sea)
